...
d.day = data.frame(d.day.temp,stringsAsFactors = FALSE)
names(d.day)=c("lowtag","julian","dropped","mu.step","sig.step","mu.altitude","sig.altitude","mu.temp","sig.temp",
               "mu.bearing","sig.bearing","mu.rel.angle","sig.rel.angle","mu.R2n","sig.R2n","mu.dx","sig.dx","mu.dy","sig.dy")
for(i in 3:19){
    d.day[,i]=as.numeric(d.day[,i])
}
head(d.day)
...
for(j in 1:n.vit){
    d.day[d.day$lowtag == individs[j],4:19]=apply(d.day[d.day$lowtag == individs[j],4:19],2,scale)
}

d.day$julian = as.integer(d.day$julian)
...
for(j in 1:n.vit){
    possible.hits[j] = sum(d.day$dropped[d.day$lowtag==individs[j]])
}
possible.hits
...
out.test=anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.day,eps=rep(.01,length(ci)),covs.indx=ci)
...
for(m in 1:3){
    for(j in 1:n.vit){
        df=d.day[d.day$lowtag!=individs[j],]
        ...
        decide=decide/100
        d.ind=d.day[d.day$lowtag==individs[j],]
...
fit.prec = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.day,eps=decide[,1],covs.indx=ci)# fit model
eval.prec=evaluate.time.pop(alarm=fit.prec$alarm,possible.hits=ph,n.vit=nv,vitdropday = d.vit$juliandropped)
par(mfrow=c(4,1))
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_prec_part1.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.step[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.step"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.step,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.step[d.day$lowtag==individs[j]],main="sig.step")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.step,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.altitude[d.day$lowtag==individs[j]],main="mu.altitude")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.altitude,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.altitude[d.day$lowtag==individs[j]],main="sig.altitude")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.altitude,col=2)
    abline(v=d.vit$juliandropped[j])
    dev.off()
}
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_prec_part2.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.temp[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.temp"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.temp,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.temp[d.day$lowtag==individs[j]],main="sig.temp")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.temp,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.bearing[d.day$lowtag==individs[j]],main="mu.bearing")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.bearing,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.bearing[d.day$lowtag==individs[j]],main="sig.bearing")
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_prec_part3.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.rel.angle[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.rel.angle"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.rel.angle,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.rel.angle[d.day$lowtag==individs[j]],main="sig.rel.angle")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.rel.angle,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.R2n[d.day$lowtag==individs[j]],main="mu.R2n")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.R2n,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.R2n[d.day$lowtag==individs[j]],main="sig.R2n")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.R2n,col=2)
    abline(v=d.vit$juliandropped[j])
    dev.off()
}
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_prec_part4.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.dx[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.dx"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.dx,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.dx[d.day$lowtag==individs[j]],main="sig.dx")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.dx,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.dy[d.day$lowtag==individs[j]],main="mu.dy")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.dy,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$sig.dy[d.day$lowtag==individs[j]],main="sig.dy")
...
###recall final model
fit.recall = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.day,eps=decide[,2],covs.indx=ci)# fit model
eval.recall=evaluate.time.pop(alarm=fit.recall$alarm,possible.hits=ph,n.vit=nv,vitdropday = d.vit$juliandropped)
par(mfrow=c(4,1))
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_recall_part1.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.step[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.step"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_recall_part2.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.temp[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.temp"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_recall_part3.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.rel.angle[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.rel.angle"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly6/",individs[j],"_recall_part4.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.day$julian[d.day$lowtag==individs[j]],d.day$mu.dx[d.day$lowtag==individs[j]],main=paste(individs[j],"mu.dx"))
...
### F1 final model
fit.F1 = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.day,eps=decide[,3],covs.indx=ci)# fit model
...
pdf(paste("outputplots_anomaly6/","AD_eval_F1_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly6/","AD_eval_F1_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 4:6){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_F1_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_F1_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_recall_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly6/","AD_eval_recall_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 4:6){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_recall_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_recall_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_prec_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly6/","AD_eval_prec_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 5:6){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_prec_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly6/","AD_eval_prec_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
