...
out.test=anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.dos,eps=rep(.1,length(ci)),covs.indx=ci)
...
for(m in 1:3){
    for(j in 1:n.vit){
        df=d.dos[d.dos$lowtag!=individs[j],]
        ...
        decide=decide/100
        d.ind=d.dos[d.dos$lowtag==individs[j],]
...
fit.prec = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.dos,eps=decide[,1],covs.indx=ci)# fit model
eval.prec=evaluate.time.pop(alarm=fit.prec$alarm,possible.hits=ph,n.vit=nv,vitdropday = d.vit$juliandropped)

###recall final model
fit.recall = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.dos,eps=decide[,2],covs.indx=ci)# fit model
eval.recall=evaluate.time.pop(alarm=fit.recall$alarm,possible.hits=ph,n.vit=nv,vitdropday = d.vit$juliandropped)

### F1 final model
fit.F1 = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.dos,eps=decide[,3],covs.indx=ci)# fit model
...
par(mfrow=c(4,1))
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_prec_part1.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_prec_part2.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_prec_part3.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_prec_part4.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
...
par(mfrow=c(4,1))
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_recall_part1.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.dos$julian[d.dos$lowtag==individs[j]],d.dos$mu.step[d.dos$lowtag==individs[j]],main=paste(individs[j],"mu.step"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_recall_part2.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.dos$julian[d.dos$lowtag==individs[j]],d.dos$mu.temp[d.dos$lowtag==individs[j]],main=paste(individs[j],"mu.temp"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_recall_part3.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.dos$julian[d.dos$lowtag==individs[j]],d.dos$mu.rel.angle[d.dos$lowtag==individs[j]],main=paste(individs[j],"mu.rel.angle"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly11/",individs[j],"_recall_part4.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.dos$julian[d.dos$lowtag==individs[j]],d.dos$mu.dx[d.dos$lowtag==individs[j]],main=paste(individs[j],"mu.dx"))
...
pdf(paste("outputplots_anomaly11/","AD_eval_F1_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly11/","AD_eval_F1_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in c(4,6)){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_F1_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_F1_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_recall_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly11/","AD_eval_recall_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 4:6){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_recall_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_recall_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_prec_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly11/","AD_eval_prec_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in c(4,6)){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_prec_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly11/","AD_eval_prec_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
save.image("anomaly_v11_day.Rdata")
...
z.dos.pop=apply(d.dos[,4:19],2,scale)
z.dos.pop
d.dos.pop=cbind(d.dos[1:3],z.dos.pop)

z.out=matrix(NA,nr=n.vit,ncol=length(4:19))

for(j in 1:n.vit){
    # z.out[j,]=apply(d.dos.pop[d.dos.pop$lowtag==individs[j],4:19],2,mean)
    z.out[j,]=apply(d.dos.pop[d.dos.pop$lowtag==individs[j],4:19],2,sd)
    }
round(z.out,2)
