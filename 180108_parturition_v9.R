...
ph=possible.hits
nv=n.vit
ci=4:19#covariate indexes

source("anomalyDetectUniv.R")
source("anomalyDetect.R")
source("evaluate_ad.R")

out.test=anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.tres,eps=rep(.1,length(ci)),covs.indx=ci)
...
for(m in 1:3){
    for(j in 1:n.vit){
        df=d.tres[d.tres$lowtag!=individs[j],]
        ...
        decide=decide/100
        d.ind=d.tres[d.tres$lowtag==individs[j],]
...
save.image("anomaly.daily.Rdata")
# load("anomaly.daily.Rdata")
...
fit.prec = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.tres,eps=decide[,1],covs.indx=ci)# fit model
eval.prec=evaluate.time.pop(alarm=fit.prec$alarm,possible.hits=ph,n.vit=nv,vitdropday = d.vit$juliandropped)

###recall final model
fit.recall = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.tres,eps=decide[,2],covs.indx=ci)# fit model
eval.recall=evaluate.time.pop(alarm=fit.recall$alarm,possible.hits=ph,n.vit=nv,vitdropday = d.vit$juliandropped)

### F1 final model
fit.F1 = anomalyDetect(n.vit=nv,part.window=pw,id=individs,d=d.tres,eps=decide[,3],covs.indx=ci)# fit model
...
par(mfrow=c(4,1))
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_prec_part1.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.step[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.step"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.step,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.step[d.tres$lowtag==individs[j]],main="sig.step")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.step,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.altitude[d.tres$lowtag==individs[j]],main="mu.altitude")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.altitude,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.altitude[d.tres$lowtag==individs[j]],main="sig.altitude")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.altitude,col=2)
    abline(v=d.vit$juliandropped[j])
    dev.off()
}
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_prec_part2.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.temp[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.temp"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.temp,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.temp[d.tres$lowtag==individs[j]],main="sig.temp")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.temp,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.bearing[d.tres$lowtag==individs[j]],main="mu.bearing")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.bearing,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.bearing[d.tres$lowtag==individs[j]],main="sig.bearing")
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_prec_part3.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.rel.angle[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.rel.angle"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.rel.angle,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.rel.angle[d.tres$lowtag==individs[j]],main="sig.rel.angle")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.rel.angle,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.R2n[d.tres$lowtag==individs[j]],main="mu.R2n")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.R2n,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.R2n[d.tres$lowtag==individs[j]],main="sig.R2n")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.R2n,col=2)
    abline(v=d.vit$juliandropped[j])
    dev.off()
}
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_prec_part4.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.dx[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.dx"))
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.dx,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.dx[d.tres$lowtag==individs[j]],main="sig.dx")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$sig.dx,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.dy[d.tres$lowtag==individs[j]],main="mu.dy")
    points(fit.prec$alarm[[j]]$julian,fit.prec$alarm[[j]]$mu.dy,col=2)
    abline(v=d.vit$juliandropped[j])
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$sig.dy[d.tres$lowtag==individs[j]],main="sig.dy")
...
par(mfrow=c(4,1))
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_recall_part1.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.step[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.step"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_recall_part2.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.temp[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.temp"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_recall_part3.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.rel.angle[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.rel.angle"))
...
for(j in 1:n.vit){
    pdf(paste("outputplots_anomaly9/",individs[j],"_recall_part4.pdf",sep=""),width=6,height=9)
    par(mfrow=c(4,1))
    plot(d.tres$julian[d.tres$lowtag==individs[j]],d.tres$mu.dx[d.tres$lowtag==individs[j]],main=paste(individs[j],"mu.dx"))
...
pdf(paste("outputplots_anomaly9/","AD_eval_F1_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly9/","AD_eval_F1_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in c(4,6)){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_F1_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_F1_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.F1$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_recall_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly9/","AD_eval_recall_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 4:6){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_recall_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_recall_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_prec_num1.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
...
pdf(paste("outputplots_anomaly9/","AD_eval_prec_num2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in c(4,6)){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_prec_num3.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
pdf(paste("outputplots_anomaly9/","AD_eval_prec_num4.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.prec$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
hit.tres.prec=matrix(NA,nr=n.vit,nc = 9)
for(j in 1:n.vit){
    hit.tres.prec[j,1]=length(unique(fit.prec$alarm[[j]]$julian[fit.prec$alarm[[j]]$julian <(d.vit$juliandropped[j]-1)]))
    hit.tres.prec[j,2]=(d.vit$juliandropped[j]-1)-126+1
    hit.tres.prec[j,3]=hit.tres.prec[j,1]/hit.tres.prec[j,2]
    hit.tres.prec[j,4]=sum(fit.prec$alarm[[j]]$julian <=d.vit$juliandropped[j]+1 & fit.prec$alarm[[j]]$julian >=d.vit$juliandropped[j]-1)>0
    hit.tres.prec[j,5]=sum(fit.prec$alarm[[j]]$julian <=d.vit$juliandropped[j]+2 & fit.prec$alarm[[j]]$julian >=d.vit$juliandropped[j]-2)>0
    hit.tres.prec[j,6]=sum(fit.prec$alarm[[j]]$julian <=d.vit$juliandropped[j]+1 & fit.prec$alarm[[j]]$julian >=d.vit$juliandropped[j]-1)
    hit.tres.prec[j,7]=sum(fit.prec$alarm[[j]]$julian <=d.vit$juliandropped[j]+2 & fit.prec$alarm[[j]]$julian >=d.vit$juliandropped[j]-2)
    hit.tres.prec[j,8]=sum(fit.prec$alarm[[j]]$julian ==d.vit$juliandropped[j])
    hit.tres.prec[j,9]=sum(fit.prec$alarm[[j]]$julian <(d.vit$juliandropped[j]-1))
    }
hit.tres.prec

write.csv(hit.tres.prec,file="tres_summary_hitday_prec.csv")

hit.tres.recall=matrix(NA,nr=n.vit,nc = 9)
...
#col9 is the total number of hits prior to vit drop day
for(j in 1:n.vit){
    hit.tres.recall[j,1]=length(unique(fit.recall$alarm[[j]]$julian[fit.recall$alarm[[j]]$julian <(d.vit$juliandropped[j]-1)]))
    hit.tres.recall[j,2]=(d.vit$juliandropped[j]-1)-126+1
    hit.tres.recall[j,3]=hit.tres.recall[j,1]/hit.tres.recall[j,2]
    hit.tres.recall[j,4]=sum(fit.recall$alarm[[j]]$julian <=d.vit$juliandropped[j]+1 & fit.recall$alarm[[j]]$julian >=d.vit$juliandropped[j]-1)>0
    hit.tres.recall[j,5]=sum(fit.recall$alarm[[j]]$julian <=d.vit$juliandropped[j]+2 & fit.recall$alarm[[j]]$julian >=d.vit$juliandropped[j]-2)>0
    hit.tres.recall[j,6]=sum(fit.recall$alarm[[j]]$julian <=d.vit$juliandropped[j]+1 & fit.recall$alarm[[j]]$julian >=d.vit$juliandropped[j]-1)
    hit.tres.recall[j,7]=sum(fit.recall$alarm[[j]]$julian <=d.vit$juliandropped[j]+2 & fit.recall$alarm[[j]]$julian >=d.vit$juliandropped[j]-2)
    hit.tres.recall[j,8]=sum(fit.recall$alarm[[j]]$julian ==d.vit$juliandropped[j])
    hit.tres.recall[j,9]=sum(fit.recall$alarm[[j]]$julian <(d.vit$juliandropped[j]-1))
}
hit.tres.recall

write.csv(hit.tres.recall,file="tres_summary_hitday_recall.csv")
...
hit.tres.recall[,3]=round(hit.tres.recall[,3],2)

out.recall=as.data.frame(cbind(Metric,t(hit.tres.recall)),stringsAsFactors=FALSE)re
...
hit.tres.F1=matrix(NA,nr=n.vit,nc = 9)
#col1 is total number of days with hits prior to day before vit drop
#col2 is the total number of days prior to vit drop
#col3 is the ratio of hits to total possible days
#col4 is the logical, whether the the algorithm hit +/- 1 day of vit drop
...
#col9 is the total number of hits prior to vit drop day
for(j in 1:n.vit){
    hit.tres.F1[j,1]=length(unique(fit.F1$alarm[[j]]$julian[fit.F1$alarm[[j]]$julian <(d.vit$juliandropped[j]-1)]))
    hit.tres.F1[j,2]=(d.vit$juliandropped[j]-1)-126+1
    hit.tres.F1[j,3]=hit.tres.F1[j,1]/hit.tres.F1[j,2]
    hit.tres.F1[j,4]=sum(fit.F1$alarm[[j]]$julian <=d.vit$juliandropped[j]+1 & fit.F1$alarm[[j]]$julian >=d.vit$juliandropped[j]-1)>0
    hit.tres.F1[j,5]=sum(fit.F1$alarm[[j]]$julian <=d.vit$juliandropped[j]+2 & fit.F1$alarm[[j]]$julian >=d.vit$juliandropped[j]-2)>0
    hit.tres.F1[j,6]=sum(fit.F1$alarm[[j]]$julian <=d.vit$juliandropped[j]+1 & fit.F1$alarm[[j]]$julian >=d.vit$juliandropped[j]-1)
    hit.tres.F1[j,7]=sum(fit.F1$alarm[[j]]$julian <=d.vit$juliandropped[j]+2 & fit.F1$alarm[[j]]$julian >=d.vit$juliandropped[j]-2)
    hit.tres.F1[j,8]=sum(fit.F1$alarm[[j]]$julian ==d.vit$juliandropped[j])
    hit.tres.F1[j,9]=sum(fit.F1$alarm[[j]]$julian <(d.vit$juliandropped[j]-1))
}
hit.tres.F1

write.csv(hit.tres.F1,file="tres_summary_hitday_F1.csv")

##############################################################################################

save.image("anomaly_v9_day.Rdata")
...
##############################################################################################
###
### Altering Anomaly Detection function 
### for smaller subset of features
###
##############################################################################################
names(d.tres)[ci]

ci = c(4:6,9,14:15)#covariate indexes
...
# pdf(paste("outputplots_anomaly9/","AD_eval_recall_num1_v2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 1:3){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
# pdf(paste("outputplots_anomaly9/","AD_eval_recall_num2_v2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 4:6){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
# pdf(paste("outputplots_anomaly9/","AD_eval_recall_num3_v2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 7:9){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
...
# pdf(paste("outputplots_anomaly9/","AD_eval_recall_num4_v2.pdf",sep=""),width=6,height=9)
par(mfrow=c(3,1))   
for(j in 10:12){
    tab = table(fit.recall$alarm[[j]]$julian)
    plot(tab,main=paste("Anomaly Detection",individs[j]),xlab = "Julian day",ylab = "Number of hits",xlim=c(126,188))
